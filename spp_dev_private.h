...
#define SPPA_CONNECTIONSMFUNC_TIMEOUT_DURATION	100
#define SPP_SENDDATA_TIMEOUT_DURATION				5
#define SPPB_CONNECT_RESP_DELAY_DURATION			100
...
enum {
	...
	SPPA_CONNECTIONSMFUNC_TIMEOUT,					/** for CONNECTIONSM* functions  timeout **/
	SPPB_PIPE_SENDDATA_TIMEOUT,
	SPPB_CONNECT_RESP_DELAY
};
