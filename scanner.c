...
#define SCANNER_MORE_DATA_TIMEOUT_DURATION		(20)
...
/**	
	MessageCancelAll(&scanner.task, SCANNER_MORE_DATA_TIMEOUT );	
**/
		...
		case MESSAGE_MORE_DATA:
			{
				...
				/**
				MessageCancelAll( &scanner.task, SCANNER_MORE_DATA_TIMEOUT );
				MessageSendLater( &scanner.task, SCANNER_MORE_DATA_TIMEOUT,  0,  SCANNER_MORE_DATA_TIMEOUT_DURATION );
				**/
				source = StreamUartSource();
			...
			break;
	/**
		case SCANNER_MORE_DATA_TIMEOUT:
		{
			barcode_t* result;
