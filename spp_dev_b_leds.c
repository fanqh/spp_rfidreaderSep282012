...
static const int gLedPinsUsed = 0x0407 ; 
...
/*RAINBOW*/ 
static const ledEntry_t pattern_RAINBOW [ 9 ] = 
{
    { 0x0002 , ON  , 100  }  , 
    { 0x0003 , ON  , 100  }  , 
    { 0x0002 , OFF , 0    }  , 
...
/*WHITE_SLOW_FLASH*/ 
static const ledEntry_t pattern_WHITE_SLOW_FLASH [ 2 ] = 
{
    { 0x0007 , ON  , 200  }  , 
    { 0x0007 , OFF , 3800 }  
}; 
/*BLUE_RED_SLOW_FLASH*/ 
static const ledEntry_t pattern_BLUE_RED_SLOW_FLASH [ 4 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 3800 }  , 
    { 0x0002 , ON  , 200  }  , 
...
/*BLUE_RED_SLOW_BURST*/ 
static const ledEntry_t pattern_BLUE_RED_SLOW_BURST [ 12 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 100  }  , 
    { 0x0004 , ON  , 200  }  , 
...
/*WHITE_RED_SLOW_FLASH*/ 
static const ledEntry_t pattern_WHITE_RED_SLOW_FLASH [ 4 ] = 
{
    { 0x0007 , ON  , 200  }  , 
    { 0x0007 , OFF , 3800 }  , 
    { 0x0002 , ON  , 200  }  , 
...
static const ledEntry_t pattern_GREEN_ON_BLUE_SLOW_FLASH [ 4 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 200  }  , 
    { 0x0001 , ON  , 3400 }  , 
...
/*RED_ON_BLUE_SLOW_BURST*/ 
static const ledEntry_t pattern_RED_ON_BLUE_SLOW_BURST [ 8 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 100  }  , 
    { 0x0004 , ON  , 200  }  , 
...
/*RED_GREEN_ON_BLUE_SLOW_BURST*/ 
static const ledEntry_t pattern_RED_GREEN_ON_BLUE_SLOW_BURST [ 8 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 100  }  , 
    { 0x0004 , ON  , 200  }  , 
...
/*GREEN_ON_BLUE_SLOW_BURST*/ 
static const ledEntry_t pattern_GREEN_ON_BLUE_SLOW_BURST [ 8 ] = 
{
    { 0x0004 , ON  , 200  }  , 
    { 0x0004 , OFF , 100  }  , 
    { 0x0004 , ON  , 200  }  , 
...
/*RED_ON_WHITE_SLOW_FLASH*/ 
static const ledEntry_t pattern_RED_ON_WHITE_SLOW_FLASH [ 4 ] = 
{
    { 0x0007 , ON  , 200  }  , 
    { 0x0007 , OFF , 200  }  , 
    { 0x0002 , ON  , 3400 }  , 
...
/*RED_GREEN_ON_WHITE_SLOW_FLASH*/ 
static const ledEntry_t pattern_RED_GREEN_ON_WHITE_SLOW_FLASH [ 4 ] = 
{
    { 0x0007 , ON  , 200  }  , 
    { 0x0007 , OFF , 200  }  , 
    { 0x0003 , ON  , 3400 }  , 
...
/*GREEN_ON_WHITE_SLOW_FLASH*/ 
static const ledEntry_t pattern_GREEN_ON_WHITE_SLOW_FLASH [ 4 ] = 
{
    { 0x0007 , ON  , 200  }  , 
    { 0x0007 , OFF , 200  }  , 
    { 0x0001 , ON  , 3400 }  , 
...
static const led_t gLeds [ LED_NUM_PATTERNS ] = 
{
    ...
    {  { 9,  0x00 , RPT }, (ledEntry_t *) pattern_RAINBOW } ,
    ...
    {  { 2,  0x00 , RPT }, (ledEntry_t *) pattern_WHITE_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_RED_SLOW_FLASH } ,

    {  { 12,  0x00 , RPT }, (ledEntry_t *) pattern_BLUE_RED_SLOW_BURST } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_WHITE_RED_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_BLUE_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_RED_GREEN_ON_BLUE_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_GREEN_ON_BLUE_SLOW_FLASH } ,

    {  { 8,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_BLUE_SLOW_BURST } ,

    {  { 8,  0x00 , RPT }, (ledEntry_t *) pattern_RED_GREEN_ON_BLUE_SLOW_BURST } ,

    {  { 8,  0x00 , RPT }, (ledEntry_t *) pattern_GREEN_ON_BLUE_SLOW_BURST } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_RED_ON_WHITE_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_RED_GREEN_ON_WHITE_SLOW_FLASH } ,

    {  { 4,  0x00 , RPT }, (ledEntry_t *) pattern_GREEN_ON_WHITE_SLOW_FLASH } ,
